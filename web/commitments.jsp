...
<body class="bg-[#f7f7fa] font-sans">
      ...
      <div class="bg-white rounded-3xl overflow-hidden shadow-xl mb-8 mt-8">
        <div class="mt-2 px-8 pb-8">
          <div class="relative rounded-[2.5rem] overflow-hidden" style="height: 200px;">
            <img src="img/study.jpg" alt="Hikari Commitments Banner" class="absolute inset-0 w-full h-full object-cover" loading="lazy" />
        ...
        <div class="commitments-grid grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="commitment-card">
            <div class="commitment-image">
              <img src="img/course.jpg" alt="Nắm vững kiến thức JLPT" class="w-full h-40 object-cover rounded-t-xl" loading="lazy" />
            </div>
          ...
          <div class="commitment-card">
            <div class="commitment-image">
              <img src="img/course.jpg" alt="Giao tiếp tự tin" class="w-full h-40 object-cover rounded-t-xl" loading="lazy" />
            </div>
            <div class="commitment-content">
          ...
          <div class="commitment-card">
            <div class="commitment-image">
              <img src="img/course.jpg" alt="Hỗ trợ luyện thi" class="w-full h-40 object-cover rounded-t-xl" loading="lazy" />
            </div>
            <div class="commitment-content">
          ...
          <div class="commitment-card">
            <div class="commitment-image">
                <img src="img/course.jpg" alt="Chứng chỉ hoàn thành" class="w-full h-40 object-cover rounded-t-xl" loading="lazy" />
            </div>
            <div class="commitment-content">
  ...
  <script src="js/commitments.js"></script>
</body>
</html>