      ...
      <div class="bg-white rounded-3xl overflow-hidden shadow-xl mb-8 mt-8">
        <div class="mt-2 px-8 pb-8">
          <div class="relative rounded-[2.5rem] overflow-hidden" style="height: 200px;">
            <img src="img/study.jpg" alt="Hikari Course Info Banner" class="absolute inset-0 w-full h-full object-cover" loading="lazy" />
      ...
      <section class="course-info-container max-w-4xl mx-auto mb-10">
        ...
        <div class="course-levels bg-white rounded-xl p-6 shadow-lg mb-6">
          ...
          <div class="level-images flex flex-wrap gap-4 mb-4">
            <img src="img/course.jpg" alt="Học viên học Listening" class="w-32 h-32 object-cover rounded-lg" loading="lazy" />
            <img src="img/course.jpg" alt="Học viên học Reading" class="w-32 h-32 object-cover rounded-lg" loading="lazy" />
            <img src="img/course.jpg" alt="Học viên học Writing" class="w-32 h-32 object-cover rounded-lg" loading="lazy" />
          </div>
        </div>
