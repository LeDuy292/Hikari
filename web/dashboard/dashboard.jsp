...
<html lang="en">
  <head>
    ...
    <!-- Custom CSS -->
    <link href="${pageContext.request.contextPath}/css/dashboard/mainDashboard.css" rel="stylesheet" />
  ...
  <body>
    ...
    <script src="${pageContext.request.contextPath}/js/dashboard/mainDashboard.js"></script>
  </body>
</html>