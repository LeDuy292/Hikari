...
<html lang="en">
  <head>
    ...
    <link href="${pageContext.request.contextPath}/css/dashboard/manaCourses.css" rel="stylesheet" />
  </head>
  <body>
    ...
    <script src="${pageContext.request.contextPath}/js/dashboard/manaCourses.js"></script>
