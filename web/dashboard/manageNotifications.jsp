...
<html lang="en">
  <head>
    ...
    <link href="${pageContext.request.contextPath}/css/dashboard/manaNotifications.css" rel="stylesheet" />
  </head>
  <body>
    ...
    <script src="${pageContext.request.contextPath}/js/dashboard/manaNotifications.js"></script>
  </body>
</html>