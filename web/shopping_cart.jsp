...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/sidebar.css?v=1"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/footer.css?v=1"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/shopping.css?v=1"/>
    <script src="${pageContext.request.contextPath}/js/shopping.js?v=1"></script>
</head>
            ...
            <div class="bg-white rounded-3xl overflow-hidden shadow-xl mb-8 mt-8">
                <div class="mt-2 px-8 pb-8">
                    <div class="relative rounded-[2.5rem] overflow-hidden" style="height: 200px;">
                        <img src="${pageContext.request.contextPath}/img/study.jpg" alt="Banner" class="absolute inset-0 w-full h-full object-cover" />
