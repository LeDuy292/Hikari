...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/manageMaterials.css" />
</head>
<body>
    ...
    <script src="${pageContext.request.contextPath}/js/manageMaterials.js"></script>
