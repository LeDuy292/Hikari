...
<html lang="en">
    <head>
        ...
        <!-- Custom CSS -->
        <link href="${pageContext.request.contextPath}/assets/css/mainDashboard.css" rel="stylesheet" />
    ...
    <body>
        ...
        <script src="${pageContext.request.contextPath}/assets/js/mainDashboard.js"></script>
    </body>
</html>