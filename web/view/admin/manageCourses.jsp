...
<html lang="en">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/assets/css/manaCourses.css" rel="stylesheet" />
    </head>
    <body>
        ...
        <script src="${pageContext.request.contextPath}/assets/js/manaCourses.js"></script>
