...
<html lang="en">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/assets/css/manaNotifications.css" rel="stylesheet" />
    </head>
    <body>
        ...
        <script src="${pageContext.request.contextPath}/assets/js/manaNotifications.js"></script>
    </body>
</html>