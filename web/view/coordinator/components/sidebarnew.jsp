...
<div class="sidebar">
    <div class="sidebar-top">
        ...
        <a href="home.jsp" class="sidebar-nav-item <%= currentPage.equals("home.jsp") ? "active" : ""%>">
            <i class="fas fa-chart-line"></i>
            <span>Trang chủ</span>
        </a>
        <a href="course-monitoring.jsp" class="sidebar-nav-item <%= currentPage.equals("course-monitoring.jsp") ? "active" : ""%>">
        ...
        <a href="instructor-assignment.jsp" class="sidebar-nav-item <%= currentPage.equals("instructor-assignment.jsp") ? "active" : ""%>">
