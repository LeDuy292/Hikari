...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/instructor-assignment.css" rel="stylesheet">
</head>
<body>
    <div class="d-flex">
        <!-- Sidebar -->
                                ...
                                <div class="instructor-list">
                                    ...
                                    <div class="instructor-card active">
                                        ...
                                        <div class="instructor-info">
                                            <h6 class="instructor-name">Nguyễn Văn A</h6>
                                            <span class="instructor-specialty">Japanese Language (N1-N2)</span>
                                        </div>
