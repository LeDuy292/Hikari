...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/courseInfo.css" />
</head>
<body class="bg-[#f7f7fa] font-sans">
  ...
  <script src="${pageContext.request.contextPath}/assets/js/courseInfo.js"></script>
</body>
</html>