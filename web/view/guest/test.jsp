...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/test_student.css" />
        ...
        <script src="${pageContext.request.contextPath}/assets/js/quiz.js?v=1"></script>
    </head>
