...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/manageMaterials.css" />
</head>
<body>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/manageMaterials.js"></script>
</body>
</html>