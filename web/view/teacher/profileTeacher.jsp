...
<html lang="vi">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/profileTeacher.css" />
    </head>
    <body>
        ...
        <script src="${pageContext.request.contextPath}/assets/js/profileTeacher.js"></script>
    </body>
</html>